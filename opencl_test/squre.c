/*************************************************************************
	> File Name: squre.c
	> Author: wangjunjie
	> Mail: wangunjie2013@gmail.com 
	> Created Time: Thu 15 Jan 2015 12:52:21 PM CST
 ************************************************************************/
...
main (int argc, char *argv[])
{
      ...
      cl_int err;cl_int/* Error code returned from api calls.  */
      size_t global;global/* Global domain size for our calculation.  */
      size_t local;size_t/* Local domain size for our calculation.  */

      cl_platform_id cpPlatform;cpPlatform/* openCL platform.  */
      cl_device_id device_id;device_id/* Compute device id.  */
      cl_context context;context/* Compute context.  */
      cl_command_queue commands;commands/* Compute command queue.  */
      cl_program program;program/* Compute program.  */
      cl_kernel kernel;kernel/* Compute kernel.  */

      /* Create data for the run.  */
      float *data = NULL;NULL/* Original data set given to device.  */
      float *results = NULL;NULL/* Results returned from device.  */
      unsigned int correct;correct/* Number of correct results returned.  */
      cl_mem input;cl_mem/* Device memory used for the input array.  */
      cl_mem output;output/* Device memory used for the output array.  */
